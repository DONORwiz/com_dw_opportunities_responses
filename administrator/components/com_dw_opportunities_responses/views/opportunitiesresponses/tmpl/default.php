...
$document->addStyleSheet('components/com_dw_opportunities_responses/assets/css/dw_opportunities_responses.css');

$user	= JFactory::getUser();
$userId	= $user->get('id');
$listOrder	= $this->state->get('list.ordering');
$listDirn	= $this->state->get('list.direction');
$canOrder	= $user->authorise('core.edit.state', 'com_dw_opportunities_responses');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_dw_opportunities_responses&task=opportunitiesresponses.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'opportunityresponseList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="opportunityresponseList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'opportunitiesresponses.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
