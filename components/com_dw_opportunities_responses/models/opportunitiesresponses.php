...
/**
 * Methods supporting a list of Dw_opportunities_responses records.
 */
class Dw_opportunities_responsesModelOpportunitiesresponses extends JModelList
{
...
if (!JFactory::getUser()->authorise('core.edit.state', 'com_dw_opportunities_responses'))
{
